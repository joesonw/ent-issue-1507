...
type UserMutation struct {
	...
	typ           string
	id            *int
	_Status       *player_pb.Status
	_Info         *player_pb.Info
...
func (m *UserMutation) SetStatus(pp player_pb.Status) {
	m._Status = &pp
}

// Status returns the value of the "Status" field in the mutation.
func (m *UserMutation) Status() (r player_pb.Status, exists bool) {
	v := m._Status
	if v == nil {
		return
	}
...
func (m *UserMutation) OldStatus(ctx context.Context) (v player_pb.Status, err error) {
...
func (m *UserMutation) SetInfo(pp player_pb.Info) {
	m._Info = &pp
}

// Info returns the value of the "Info" field in the mutation.
func (m *UserMutation) Info() (r player_pb.Info, exists bool) {
	v := m._Info
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldInfo(ctx context.Context) (v player_pb.Info, err error) {
	if !m.op.Is(OpUpdateOne) {
